...
export function ChatContainers() {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:5004/ask-finance", {
        method: "POST",
      ...
      setMessages((prev) => [
        ...prev,
        { content: "An error occurred while fetching the response.", type: "bot", timestamp: new Date() },
      ]);
    }
