...
export default function Component() {
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2 bg-[#daede6]">
      {/* Left section for login */}
      <div className="h-full flex-col items-center justify-center px-8 lg:flex lg:px-16">
        <div className="space-y-6 pt-16 text-center">
          ...
          <p className="text-lg text-gray-600">
            Log in or create an account to access your personalized financial
            dashboard and expert advice.
          </p>
        </div>
      ...
      {/* Right section for feature highlights */}
